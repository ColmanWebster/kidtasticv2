  ...
  return (
    <div className="Countdown" style={{ display: show ? "block" : "none" }}>
      ...
      <div className="Countdown-display">
        <button className="martinsButton" name="3600" onClick={calculateTime}>
          H &#8679;
        </button>
        <button className="martinsButton" name="60" onClick={calculateTime}>
          M &#8679;
        </button>
        <button className="martinsButton" name="1" onClick={calculateTime}>
          S &#8679;
        </button>
