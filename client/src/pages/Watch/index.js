      ...
      <Grid container spacing={1}>
        ...
        <Grid item lg={4} md={5} sm={6}>
          <Paper className={classes.intropapers} xs={2}>
            ...
            <p>
              <b>
                Welcome to the Watch Page, scroll down to choose from a wide
                variety of shows. Once chosen, sit back and relax! That's it!
              </b>
            </p>
            <p>
              <b>
                We have disabled all in-video clicking for all videos and we
                have added in our own buttons instead to ensure safety.
              </b>
            </p>
          </Paper>
          <Paper className={classes.image}>
            <img src="./assets/images/eyesk.png" alt="eyes" className="md" />
            <Hidden only={["sm", "md", "lg", "xl"]}>
              <img src="./assets/thumbs/eyesg.jpg" alt="eyes" className="md" />
              <img src="./assets/thumbs/eyesp.jpg" alt="eyes" className="md" />
            </Hidden>
          </Paper>
          <Paper className={classes.intropapers}>
            ...
            <p>
              <b>
                We do not own any of these videos. These videos are uploaded via
                YouTube from many different accounts. We go through these videos
                and find the best ones and share it so you can enjoy. If you
                have any questions, comments, concerns, or would like to suggest
                a video please refer here.
              </b>
            </p>
          </Paper>
          {/* <button
